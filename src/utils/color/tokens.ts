...
export const generateTokens = (
  ...
  const semantic: GeneratedTokens['semantic'] = {
    light: {
      background: {
  ...
  const components: GeneratedTokens['components'] = {
    input: {
      background: createTokenValue('{semantic.background.primary}', 'color'),
      border: createTokenValue('{semantic.border.default}', 'color'),
      borderHover: createTokenValue('{semantic.border.hover}', 'color'),
      borderFocus: createTokenValue('{semantic.border.focus}', 'color'),
      placeholder: createTokenValue('{semantic.foreground.muted}', 'color'),
      foreground: createTokenValue('{semantic.foreground.primary}', 'color'),
    ...
    button: {
      primary: {
        background: createTokenValue('{semantic.accent.default}', 'color'),
        backgroundHover: createTokenValue('{semantic.accent.hover}', 'color'),
        foreground: createTokenValue('{semantic.accent.foreground}', 'color'),
      ...
      secondary: {
        background: createTokenValue('{semantic.background.secondary}', 'color'),
        backgroundHover: createTokenValue('{semantic.background.tertiary}', 'color'),
        foreground: createTokenValue('{semantic.foreground.primary}', 'color'),
        borderRadius: createTokenValue('{global.radius.md}', 'borderRadius'),
        paddingX: createTokenValue('{global.spacing.lg}', 'spacing'),
        paddingY: createTokenValue('{global.spacing.sm}', 'spacing'),
      ...
      ghost: {
        ...
        backgroundHover: createTokenValue('{semantic.background.secondary}', 'color'),
        foreground: createTokenValue('{semantic.foreground.primary}', 'color'),
        borderRadius: createTokenValue('{global.radius.md}', 'borderRadius'),
        paddingX: createTokenValue('{global.spacing.lg}', 'spacing'),
        paddingY: createTokenValue('{global.spacing.sm}', 'spacing'),
  ...
  return { global, semantic, components };
};
